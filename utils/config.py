...
def create_parser():
    ...
    # Haixia options
    parser.add_argument('--repetition-id', default=1, type=int, help='Repetition id (default: 1)')
    parser.add_argument('--participant-id', default=0, type=int, help='Participant ID (default: 0)')
